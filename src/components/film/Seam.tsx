 ...
 * The seam of light.
 *
 * The door is ajar. This is the first of the four rationed amber uses
 ...
 *   `--seam-spill`  0 → 260px   the amber falling into the room
 *
 * Spec: The Film.html §I — *"Reveals happen by light (the seam widening
 * 3px→9px, amber spill growing 0→260px), never by element motion."* This is
...
export function Seam() {
  return (
    <div aria-hidden="true" className="pointer-events-none absolute inset-y-0 left-0 z-[1]">
      {/* The spill — amber falling across the floor from the doorway. */}
      <div
        className="absolute inset-y-0 left-0"
        style={{
          width: 'var(--seam-spill, 260px)',
          background:
            'linear-gradient(90deg, rgba(233,162,59,0.07), transparent)',
        }}
      />
      ...
      <div
        ...
        style={{
          ...
          background:
            'linear-gradient(180deg, transparent, #E9A23B 40%, #E9A23B 60%, transparent)',
        }}
      />
    </div>
  )
